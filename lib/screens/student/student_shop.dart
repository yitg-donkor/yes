...
class _StudentShopPageState extends State<StudentShopPage> {
  ...
  // Selected pharmacy filter — null = all pharmacies
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        ..._pharmacies.map((p) => _pharmacyChip(
                              p['id'] as String,
                              p['name'] as String,
                  ...
                  // Show selected pharmacy rating if one is picked
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _infoChip(
                      'Stock: $maxQty', Icons.inventory, Colors.blue),
                  const SizedBox(width: 8),
                  if (p['requires_prescription'] == true)
                    _infoChip('Prescription required',
              ...
              Row(
                ...
                children: [
                  Text('Total: GH₵ ${(price * qty).toStringAsFixed(2)}',
                      style: const TextStyle(
            ...
            ElevatedButton(
              onPressed: selectedRating == 0
                  ...
                  : () async {
                      ...
                      Navigator.pop(ctx);
                      setState(() {}); // refresh rating display
